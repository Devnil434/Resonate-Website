...
function App() {
  ...
  useEffect(() => {
    ...
    const lenis = new Lenis({
      ...
      smooth: !prefersReducedMotion, // Disable smooth scroll if reduced motion
      mouseMultiplier: 1,
      smoothTouch: false,
      touchMultiplier: 2,
    });
    ...
    return () => {
      ...
      ctx.revert(); // This kills all GSAP animations and ScrollTriggers created in this context
    };
  }, []);
